...
evalBegins = FilterStringBeginsWith()	#начинается ли строка с указанного значения
evalCon = FilterStringContains()		#содержит ли строка указанное значение
evalEnds = FilterStringEndsWith()		#заканчивается ли строка на указанное значение
evalEq = FilterStringEquals()			#равна ли строка указанному значению
evalGreat = FilterStringGreater()		#является ли строка лексикографически больше указанного значения
evalGoEq = FilterStringGreaterOrEqual()	#является ли строка лексикографически больше или равна указанному значению
evalLess = FilterStringLess()			#является ли строка лексикографически меньше указанного значения
evalLoEq = FilterStringLessOrEqual()	#является ли строка лексикографически меньше или равна указанному значению
...
# Does the mark string contain the test value 'k.'
test = 'k'
